...
1. **Set your values** using the tables above as a starting point
2. **Go into Training Mode** and spend 10–15 minutes hitting still and moving targets at every range
3. **Play 5 full matches** without changing anything — you need real game context, not training room feelings
4. **Identify one specific problem** (e.g., 6x shots drift left) and adjust only that scope's sensitivity by 2–3 points
5. **Repeat** until you stop thinking about your sensitivity mid-fight
