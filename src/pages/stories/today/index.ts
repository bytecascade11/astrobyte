...
export const GET: APIRoute = async () => {
  const allCollections = ['blog', 'codm', 'efootball', 'pubgmobile', 'mlbb', 'samsung', 'xiaomi', 'tecno', 'motorola', 'huawei', 'honor', 'oneplus', 'pixel', 'nothing', 'apple', 'oppo', 'vivo', 'infinix', 'freefire'];
