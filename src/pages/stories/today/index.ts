...
export const GET: APIRoute = async () => {
  const allCollections = ['blog', 'codm', 'efootball', 'pubgmobile', 'mlbb', 'samsung', 'xiaomi', 'tecno', 'motorola', 'huawei', 'honor', 'oneplus', 'pixel', 'nothing', 'iphone', 'oppo', 'vivo', 'infinix', 'freefire'];
